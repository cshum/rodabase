...
module.exports = function(path, opts){
  ...
  Roda.fn.define('validate', params('result'), xparams, null);
  Roda.fn.define('diff', params('current','result','transaction'), xparams, null);
  Roda.fn.define('conflict', params('conflict','result','transaction'), xparams, null);
